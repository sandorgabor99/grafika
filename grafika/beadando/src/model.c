...
void init_entities(World* world) {
	...
	world->room.back = load_texture("textures//hatter1.jpg");
	world->room.front = load_texture("textures//royal.jpg");
	world->room.left = load_texture("textures//royal.jpg");
	world->room.right = load_texture("textures//royal.jpg");
